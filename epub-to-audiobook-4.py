...
def epub_to_audiobook(epub_path, output_path, lang='en'):
    ...
    try:
        ...
        print(f"Speech conversion and export completed. Time taken: {time.time() - start_time:.2f} seconds")
...
# Usage
epub_to_audiobook('当尼采哭泣.epub', 'audio-book-4.mp3')
